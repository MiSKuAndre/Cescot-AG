...
function esercizio01() {
    ...
    document.getElementById('es1-dataInserita').innerText = giorno + "/" + mese + "/" + anno;  //fa comparire nell'html la data inserita dall'utente
    ...
    document.getElementById("es1-risultato").innerText = risultato; //fa comparire nell'html il risultato
}
